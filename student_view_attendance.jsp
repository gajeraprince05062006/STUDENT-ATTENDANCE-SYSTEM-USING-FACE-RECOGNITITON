...
<div class="card">
    ...
    <form id="dateForm" action="" method="get">
        <label for="name"><b>Enter Proper Name With Enrollment no :</b></label><br>
        <input type="text" id="name" name="name" placeholder="Enter Name with Enrollment no :" required><br>
...
<div class="container show-container">
    ...
    <ul class="responsive-table">
        <li class="table-header">
            <div class="col col-1">Full Name With Enrollment No.</div>
        ...
        <%
            ...
            String query = "SELECT * FROM attendance WHERE name_enrollment_no = ?";
            ...
            while (resultSet.next()) {
                String date = resultSet.getString("date"); // Corrected column name
