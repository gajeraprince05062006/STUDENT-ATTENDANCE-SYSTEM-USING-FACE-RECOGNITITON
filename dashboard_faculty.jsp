...
%>
        <div class="card">
            <p>No data available for the entered date.</p>
        </div>
<%
    } else {
%>
        <div class="container show-container">
            ...
            <ul class="responsive-table">
                ...
                <!-- Loop through ResultSet and display data -->
                <% while (resultSet.next()) { %>
                    <li class="table-row">
                        <div class="col col-1" data-label="Full Name With Enrollment No."><%= resultSet.getString("name_enrollment_no") %></div>
                        <div class="col col-2" data-label="Date"><%= dateFormatOutput.format(resultSet.getDate("date")) %></div>
