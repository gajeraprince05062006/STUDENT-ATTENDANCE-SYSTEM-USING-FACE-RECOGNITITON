...
<%
    ...
    String enrollmentNumber = request.getParameter("enrollmentNo");
...
%>
    ...
    <div class="forward-button-container">
        <form action="student_view_attendance.jsp">
            <button class="forward-button" type="submit">View Attendance</button>
        </form>
    </div>
    
    <div class="forward-button-container">
        <form action="s_login.jsp">
